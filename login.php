		...
		<div class="container">
			...
			<form action="git-Login.php" method="POST">
				<div class="form-group">
					...
					<input type="email" name="email" class="form-control" placeholder="Email 'b201210031@sakarya.edu.tr'" required="required">
				</div>
				<div class="form-group">
					<label for="password">Password</label>
					<input type="password" name="password" class="form-control" placeholder="Şifre 'b201210031'" required="required">
				</div>
